    ...
    <section className="flex items-center justify-center ">
      <div className="flex flex-col justify-center items-center py-30 lg:px-[15%] content-center">
        <div className="max-w-3xl  text-center px-4 lg:px-0">
          <h1 className="text-5xl  font-serif  tracking-tight leading-tight mb-9 ">
            Career History
          </h1>

          <div className="relative w-full max-w-3xl md:max-w-5xl mx-auto p-4">
            ...
            {historyData.map((item, index) => (
              <div key={index} className="relative pl-12 md:pl-0 pb-12">
                {/* Icon Container */}
